                ...
                <div className="w-full max-w-lg mx-auto" style={{ perspective: "1000px" }}>
                  ...
                  >
                    ...
                    <div style={{ backfaceVisibility: "hidden", position: "absolute", inset: 0 }}
                      className="bg-white dark:bg-gray-800 border-2 border-indigo-100 dark:border-gray-700 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center text-center gap-3 hover:shadow-xl transition-shadow">
                      ...
                      <span className="text-xs text-gray-400 dark:text-gray-500 mt-2 animate-pulse">Click or press Space to reveal</span>
                    </div>
                    {/* Back */}
                    <div style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)", position: "absolute", inset: 0 }}
                      className="bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-600 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center text-center gap-3">
